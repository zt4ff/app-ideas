...
const idb_1 = __importDefault(__webpack_require__(/*! idb */ "./node_modules/idb/build/index.js"));
class Customer {
    constructor(dbname) {
        this.close = () => {
            this.db.close();
        };
        this.loadInitialData = (customerData) => __awaiter(this, void 0, void 0, function* () {
            this.db = yield idb_1.default.openDB(this.dbname, 1, {
                upgrade(database) {
                    let objectStore;
